...
- **Every page body is a placeholder.** Twelve lectures, twelve studios and
  ...
  All twelve weeks now process the cohort of sixteen that Week 4 fixes: Week 9
  runs two rounds of eight at a four-minute clock, and Week 12's final jury
  splits into two parallel rooms, since sixteen twenty-minute defences do not
  fit a three-hour block.
