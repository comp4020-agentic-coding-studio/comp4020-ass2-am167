# COMP4020 course-site prototype

Your repo for a COMP4020 course-site deliverable: an Astro build on the
`astro-theme-slop` platform, deploying to GitHub Pages. The deployed site is
...
- `spec/data-integrity.test.ts` and this deliverable's `spec/*.test.ts` inspect
