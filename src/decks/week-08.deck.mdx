...
Open on the deficit, not the theory. The number is on the next
  slide is illustrative; distinguish it from the 22% studio target.
```
...
A separate worked hypothetical: close a **₡9,000/month** deficit using different combinations of services and taxes. The following comparisons teach opportunity cost; they are not the Week 8 submission target.

Monday’s studio instead cuts **22% of eligible allocated outlay**, protecting both utility increments. Use the resource worksheet’s explicit denominator.
...
*Worked hypothetical: shares are typical for a Kerrow-corridor save at this
week; read your own fiscal panel for your figures.*
...
*Worked hypothetical: illustrates the mechanism, not a measured result from
any specific save.*
...
| Defer the water-production increment | +₡6,800 | Capacity risk persists | Rejected: protected in the studio allocation |

*Worked hypothetical: five illustrative moves, not a ranked or exhaustive
menu against any one save.*
...
*Worked hypothetical: a sixteen-week projection from this week's closure
choice, not a recorded outcome.*
...
*Worked hypothetical: the corridor's own Week 5/6 build costs, typical of
studio saves; substitute your own upkeep readout.*
...
The studio removes 22% of eligible worksheet outlay, protecting both utility increments. The ₡9,000 examples above are separate worked hypotheticals, not a deficit applied to your save.

- **Studio session**, Monday: compose the 22% cut in the room. Arrive with the
