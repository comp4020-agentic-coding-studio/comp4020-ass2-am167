...
**Step 2.** A second completion adds 198 u: draw reaches 1,340 u against 1,200 u installed. The shortfall is 140 u. Only now does the bar turn red. In this worked hypothetical, the first notice follows four days later; the 1,142 u checkpoint was not yet a failure.
