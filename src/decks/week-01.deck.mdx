...
- Twelve lectures, twelve studio sessions, three assessed pin-ups with a
  jury.
- Assessed submissions include screenshots, a memo and the save. Week 1 uploads an untouched archive and a one-page site report.
...
- Where two metrics conflict, name which one you traded and why. A plan that
  claims all three must account for costs and who benefited.
...
| Prevailing wind | Wind arrows, inside the air pollution view | Which ground is downwind of which |
...
- Monday studio 13:00–16:00, Studio 2.14. Upload the untouched save and report by 21:00.
