...
## A separate widening hypothetical

Worked hypothetical: these figures illustrate the mechanism;
students substitute their own save's numbers.
...
| Bus line passengers, daily | 3,900 | 3,510 | 3,180 |
...
| Modal | Drive instead of taking the bus | Transportation Overview, passengers per line |
...
| Shifted off the Pelling Street bus | +180 | modal | Bus daily passengers, 3,900 → 3,180 |
...
## Downs–Thomson: the bus set the speed
...
- So the widening's long-run car speed was never a property of the road. It
  was a property of the bus.
- And the widening pulled 180 veh/h off the bus, which cut the line's
  revenue, which — for most of the studio — was met by cutting the fleet
  from the four vehicles issued in Week 5 to three.
- A 6-minute headway became an 8-minute headway. Average wait rose from
  3 minutes to 4. The competing trip got worse, so the equilibrium car
...
Pelling Street frontage, before the widening and one simulated year
after.
...
>
> The lane raised peak speed by 17 km/h on day one and 6.5 metres of
...
## A working week and its evidence record

- No weighted assessment is due in Week 6. Upload the save, statement and evidence by 21:00; preserve the before-and-after record for
...
- **Week 7 — Infrastructure You Don't See**, Nadia Ilkhom. Water, sewage,
  power and the capacity curve. Its deck follows the same evidence discipline as the other eleven.
