...
The redundancy test, stated as a procedure students run on Monday:
...
- Save as `<student ID>-w02`, off-machine copy as usual. Monday studio, 13:00–16:00; upload the record by 21:00.
