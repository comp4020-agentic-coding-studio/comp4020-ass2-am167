---
title: "Resilience: Hazards, Pollution and Climate"
description: >-
  Hazard, pollution and climate as design constraints rather than events —
...
- **Ian Burton, Robert Kates and Gilbert F. White, *The Environment as
  ...
  use system; the event alone is only weather.
- **Gilbert F. White, *Human Adjustment to Floods* (1945), with Raymond
  ...
  invites occupation of the protected ground — written about flood levees,
  this week runs the same mechanism on fire defences.
- **C. S. Holling, "Resilience and Stability of Ecological Systems" (*Annual
  ...
  system absorbs before it flips to a different state.
- **Ian McHarg, *Design with Nature* (1969).** Layered suitability mapping —
  ...
  constraint layers before drawing anything.
...
Thackray corridor's fire load case.
...
**Fiscal performance against livability.** The forced decision sits on the
ridge flank of the Thackray corridor: the blocks that grew fastest around
Thackray Cut's western stops in Week 5, against the treeline on Verrall
Ridge — the Week 1 rejected site, and the exact forest the studio's load case
begins a fire in.

Students must choose one of two moves before the studio session ends.

- **Withdraw the ridge-flank land.** Dezone it and hold the ground as a
  maintained firebreak. Livability rises — the exposure and its notification
  load disappear entirely. Fiscal performance falls: the corridor-edge rate
  revenue leaves the ledger, and the bus and pipe already built to serve it
  now serve nothing and still cost their upkeep.
- **Defend the ridge-flank land.** Clear a defensible perimeter, underground
  or reroute the power line, and add response capacity at Thackray Cut, then
  keep the blocks zoned. Fiscal performance holds. Livability holds at its
  current reading day to day. The exposure does not go away, it concentrates —
  and by White and Burby's safe-development paradox, defended ground attracts
  higher-density redevelopment right up to the treeline, which is exactly the
  exposure the defence was meant to reduce.
...
already submitted in Week 9 — the firebreak-as-corridor-edge move is a
livability argument and an infrastructure argument in the same drawing, which
is the kind of double-duty the capstone rewards.
